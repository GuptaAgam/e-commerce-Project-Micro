package com.agam.ecommerce.email;

import com.agam.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        messageHelper.setFrom("contact@aliboucoading.com");

        final String templateName = EmailTemplate.PAYMENT_CONFIRMATION.getSubject();
    ...
    public void sendOrderConfirmationEmail(
        ...
        final String templateName = EmailTemplate.ORDER_CONFIRMATION.getSubject();
